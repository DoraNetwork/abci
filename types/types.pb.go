...
func (KVPair_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39, 0} }
...
type Request_DeliverTx struct {
	DeliverTx *RequestDeliverTx `protobuf:"bytes,10,opt,name=deliver_tx,json=deliverTx,oneof"`
}
...
type Request_GetTx struct {
	GetTx *RequestGetTx `protobuf:"bytes,13,opt,name=get_tx,json=getTx,oneof"`
}
...
func (*Request_GetTx) isRequest_Value()      {}
...
func (m *Request) GetGetTx() *RequestGetTx {
	if x, ok := m.GetValue().(*Request_GetTx); ok {
		return x.GetTx
	}
	return nil
}
...
func _Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Request_GetTx:
		...
		if err := b.EncodeMessage(x.GetTx); err != nil {
			return err
		}
	case nil:
	default:
...
func _Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 12: // value.commit
		...
		return true, err
	case 13: // value.get_tx
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestGetTx)
		err := b.DecodeMessage(msg)
		m.Value = &Request_GetTx{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *RequestCheckTx) GetLocal() bool {
	if m != nil {
		return m.Local
	}
	return false
...
func (m *RequestGetTx) Reset()                    { *m = RequestGetTx{} }
func (m *RequestGetTx) String() string            { return proto.CompactTextString(m) }
func (*RequestGetTx) ProtoMessage()               {}
func (*RequestGetTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{12} }

func (m *RequestGetTx) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *RequestGetTx) GetFrom() int32 {
	if m != nil {
		return m.From
	}
	return 0
...
func (m *RequestGetTx) GetTo() int32 {
	if m != nil {
		return m.To
	}
	return 0
...
type Response_GetTx struct {
	GetTx *ResponseGetTx `protobuf:"bytes,13,opt,name=get_tx,json=getTx,oneof"`
}
...
func (*Response_GetTx) isResponse_Value()      {}
...
func (m *Response) GetGetTx() *ResponseGetTx {
	if x, ok := m.GetValue().(*Response_GetTx); ok {
		return x.GetTx
	}
	return nil
}
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 13: // value.get_tx
		...
		msg := new(ResponseGetTx)
		err := b.DecodeMessage(msg)
		m.Value = &Response_GetTx{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*ResponseDeliverTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }
...
func (*ResponseCommit) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{25} }
...
type ResponseGetTx struct {
	Code     uint32 `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Response []byte `protobuf:"bytes,2,opt,name=response,proto3" json:"response,omitempty"`
}

func (m *ResponseGetTx) Reset()                    { *m = ResponseGetTx{} }
func (m *ResponseGetTx) String() string            { return proto.CompactTextString(m) }
func (*ResponseGetTx) ProtoMessage()               {}
func (*ResponseGetTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{26} }

func (m *ResponseGetTx) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseGetTx) GetResponse() []byte {
	if m != nil {
		return m.Response
	}
	return nil
...
type Header struct {
	...
	Random         *VrfRandom `protobuf:"bytes,10,opt,name=vrf_random,json=vrfRandom" json:"vrf_random,omitempty"`
...
func (m *Header) GetRandom() *VrfRandom {
	if m != nil {
		return m.Random
	}
	return nil
...
func (m *Header) GetProposer() []byte {
	if m != nil {
		return m.Proposer
	}
	return nil
...
func (*BlockID) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{33} }
...
func (*PartSetHeader) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func (*Validator) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
func (*VoteInfo) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func (m *VrfRandom) Reset()                    { *m = VrfRandom{} }
func (m *VrfRandom) String() string            { return proto.CompactTextString(m) }
func (*VrfRandom) ProtoMessage()               {}
func (*VrfRandom) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{38} }

func (m *VrfRandom) GetSeed() []byte {
	if m != nil {
		return m.Seed
	}
	return nil
...
func (m *VrfRandom) GetProof() []byte {
	if m != nil {
		return m.Proof
	}
	return nil
...
func (*KVPair) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39} }
...
func init() {
	...
	proto.RegisterType((*RequestGetTx)(nil), "types.RequestGetTx")
	...
	proto.RegisterType((*ResponseGetTx)(nil), "types.ResponseGetTx")
	...
	proto.RegisterType((*VrfRandom)(nil), "types.VrfRandom")
...
type ABCIApplicationClient interface {
	...
	GetTx(ctx context.Context, in *RequestGetTx, opts ...grpc.CallOption) (*ResponseGetTx, error)
}
...
func (c *aBCIApplicationClient) GetTx(ctx context.Context, in *RequestGetTx, opts ...grpc.CallOption) (*ResponseGetTx, error) {
	out := new(ResponseGetTx)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/GetTx", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	GetTx(context.Context, *RequestGetTx) (*ResponseGetTx, error)
}
...
func _ABCIApplication_GetTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestGetTx)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).GetTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/GetTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).GetTx(ctx, req.(*RequestGetTx))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTx",
			Handler:    _ABCIApplication_GetTx_Handler,
		},
	},
...
var fileDescriptorTypes = []byte{
	...
	,
}
